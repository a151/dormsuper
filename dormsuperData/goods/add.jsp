...
<body>
<form class="form-inline definewidth m20" id="form1" action="goodsAdd.action" method="post" enctype="multipart/form-data">
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><input type="text" name="g_name" id="g_name" value="" /><span id="g_nametip" style="color:red; margin-left: 10px;"></span></td>
    </tr>
    <tr>
